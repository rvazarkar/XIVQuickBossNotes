namespace BossNotes.ARR.Dungeons.HSunkenTempleBosses
{
    public class DamagedAdjudicator : Boss
    {
        public DamagedAdjudicator()
        {
            ...
            InDepthStrategy = @"Do not attack the boss itself, attack the body part with the core. The core is indicated by a bright, red orb. Once the body part with the core is destroyed, the boss will break apart and adds will spawn. Kill the adds and repeat the process til the boss is dead.
