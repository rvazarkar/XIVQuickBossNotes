namespace BossNotes.ARR.Dungeons.HCopperbellBosses
{
    public class Ouranos : Boss
    {
        ...
        {
            Name = "Ouranos";
            QuickStrategy = @"Healer should pick up rocks and drop them on the sand only when worms are looking for food.";
            InDepthStrategy = @"Non-tank players should not stand in front of the boss. Avoid its circular AoE attacks and kill Giga adds when they spawn.
