namespace BossNotes.ARR.AllianceRaids.LabyrinthBosses
{
    public class BoneDragon : Boss
    {
        public BoneDragon()
        {
            ...
            InDepthStrategy = @"Bone Dragon is the 1st boss of the Labyrinth of the Ancients. Players will encounter the Dragon when they take the left path from the entrance. Bone Dragon must be killed 3 times before it is finally defeated.
