...
Free players trapped in mist by attacking them.";
            InDepthStrategy = @"Rime Wreath: High party-wide damage, mitigate and heal through this. The Mist Dragon will spam this attack when it isn't casting anything else.
