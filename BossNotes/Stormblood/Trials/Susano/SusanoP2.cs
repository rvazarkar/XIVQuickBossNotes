namespace BossNotes.Stormblood.Trials.Susano
{
    public class SusanoP2 : Boss
    {
        public SusanoP2()
        {
            ...
            InDepthStrategy = @"At the beginning of Phase 2, a flower-shaped crystal will appear on the platform. The Main Tank should pick this up as the player who picks it up will be the one receiving continuous damage from Susano during this phase.
