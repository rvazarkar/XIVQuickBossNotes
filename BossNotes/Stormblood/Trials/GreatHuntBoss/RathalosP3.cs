...
Healers should cleanse frequently.";
            InDepthStrategy = @"After Rathalos has bathed the arena in flames, the background music will change, and the outer-arena will receive a flaming makeover. All players will now receive a debuff – Scalebound – which will reduce all healing received by players to 0 (except Mega Potions). As a result, each player should consider drinking a Mega Potion if their HP reaches medium or low levels. Party shielding, however, is unaffected by this debuff and can be very useful for mitigating burns, poison, or even some direct attacks from Rathalos himself.
