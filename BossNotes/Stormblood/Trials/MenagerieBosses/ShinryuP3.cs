...
Break chains by moving apart from each other.";
            InDepthStrategy = @"This phase opens with the party landing on a three-by-three grid of large platforms, with Shinryu using his new line charge attack almost immediately. This has a short knockback, so either get clear of it entirely (corners) or stand as far away from the edges as possible and soak the damage.
