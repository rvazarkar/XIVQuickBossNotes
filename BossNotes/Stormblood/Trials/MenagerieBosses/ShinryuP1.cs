...
When ""Judgement Bolt"" is cast, don't stand in puddles.";
            InDepthStrategy = @"When the gauge reaches 100 for the first time, run to the edge with the pillar of water falling from the sky to avoid being pushed off. Healers: use Rescue to save people by pulling them to the edge.
