namespace BossNotes.ARR.Dungeons.HBrayfloxBosses
{
    public class GobmachineGVI : Boss
    {
        public GobmachineGVI()
        {
            ...
            InDepthStrategy =
                @"The machine itself doesn't have many attacks, a straight forward flamethrower attack with no AoE cone, and a Bombardment Circle-AoE attack that'll target a random player.
